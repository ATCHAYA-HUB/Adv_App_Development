...
const Companionship = () => {
  ...
  return (
    <div>
        <div style={{backgroundColor:"black", marginTop:"-1.5%",padding:"20px 0px 0px 0px",width:"1267px"}} className="hcontianer">
        ...
        <br/>
        <center><h2 style={{fontSize:"40px"}}>Companionship</h2>
        <h2>Sense of Friendship</h2></center>
